...
with open('lib/screens/student_dashboard.dart', 'r') as f:
    content = f.read()

# 1. Imports
content = content.replace("import 'package:frontend/screens/student_timetable.dart';", "import 'package:frontend/screens/student_timetable.dart';\nimport 'package:shared_preferences/shared_preferences.dart';")
...
# 3. Dynamic name
content = content.replace("'Arun Kumar',", "_userName,")
...
with open('lib/screens/student_dashboard.dart', 'w') as f:
    f.write(content)
